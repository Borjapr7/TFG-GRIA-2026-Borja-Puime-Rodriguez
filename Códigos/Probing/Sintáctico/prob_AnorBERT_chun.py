...
# Bucle para leer todos los bloques
for b in range(num_bloques):
    ...
    # Iteramos por cada oración dentro del bloque
    for oracion in bloque_oraciones:
        # 1. Extraemos las etiquetas POS de esta oración
        etiquetas_oracion = oracion['chunk_labels']
        y_labels.extend(etiquetas_oracion)
        
        # 2. Extraemos los embeddings de cada capa para esta oración
